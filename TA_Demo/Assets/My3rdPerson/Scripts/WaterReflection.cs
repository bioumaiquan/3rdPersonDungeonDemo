...
public class WaterReflection : MonoBehaviour {
    ...
    [HideInInspector]public int textureSize = 1024;
    ...
    public void OnWillRenderObject()
    {
        ...
        if (Shader.globalMaximumLOD == 1000)
            ...
            texSize = textureSize >> 1;

        Camera reflectionCamera;
        CreateWaterObjects(cam, out reflectionCamera, texSize);
        ...
        else
        {
            ...
            GL.invertCulling = oldCulling;
            material.SetTexture("_RealReflectionTex", m_ReflectionTexture);
