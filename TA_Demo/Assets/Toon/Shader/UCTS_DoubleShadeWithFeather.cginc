...
//v.2.0.4
                ...
                //v.2.0.5
                float3 defaultLightColor = saturate(max(half3(0.5,0.5,0.5)*_Unlit_Intensity,max(ShadeSH9(half4(0.0, 0.0, 0.0, 1.0)),ShadeSH9(half4(0.0, -1.0, 0.0, 1.0)).rgb)*_Unlit_Intensity));
